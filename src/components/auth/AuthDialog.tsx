        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="bg-black border-2 border-primary clip-corner-tl-br max-w-sm">
                ...
                <button
                    ...
                    className="w-full h-12 mt-2 bg-white text-black font-body text-sm font-semibold clip-corner-tr flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors"
                >
                ...
                <button
                    ...
                    className="w-full text-muted-foreground hover:text-white text-sm font-body underline underline-offset-4 transition-colors"
                >
                    Continue without account
                </button>
