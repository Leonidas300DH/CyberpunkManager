    ...
    return (
        <div className="relative">
            <button
                ref={buttonRef}
                onClick={() => setOpen(v => !v)}
                className={`p-2 border border-border clip-corner-tr transition-colors ${
                    open
            ...
            {open && (
                <div
                    ref={panelRef}
                    className="absolute right-0 top-full mt-2 z-50 w-80 bg-surface-dark border border-border clip-corner-tl-br p-4 space-y-4"
                >
                    {/* Cards per row */}
                    <div>
