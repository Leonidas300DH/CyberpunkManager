                                ...
                                <div key={action.id}>
                                        ...
                                        <>
                                            {(hasRange || hasSkill || hasArmor) && (
                                                <div className="-ml-2 flex items-center gap-2">
                                                    ...
                                                    {hasRange && (
                                                        <div className="w-[60%]">
                                                            <RangeArrows red={src.rangeRed} yellow={src.rangeYellow} green={src.rangeGreen} long={src.rangeLong} />
                                                        </div>
                                                    )}
                                                </div>
                                            )}
                                    ...
                                    {hasRange2 && (
                                        <div className="-ml-2 flex items-center gap-2">
                                            ...
                                            <div className="w-[60%]">
                                                <RangeArrows red={!!src.range2Red} yellow={!!src.range2Yellow} green={!!src.range2Green} long={!!src.range2Long} />
                                            </div>
                                        </div>
                                    )}
                                </div>
                                ...
                                {action.range !== 'Self' && action.range !== 'Reach' ? (
                                    <>
                                        <div className="-ml-2 flex items-center gap-1.5">
                                            ...
                                            <div className="w-[60%]">
                                                <RangeArrows {...rangeTypeToFlags(action.range)} />
                                            </div>
                                        </div>
                                        <div className="font-body text-[11px] leading-snug text-white/90">
