            ...
            <>
                ...
                <div ref={weaponGridRef} className={gridClass}>
                    {variantCards.map(({ weapon, variant }) => {
                        ...
                        const skillIcon = weapon.skillReq ? ({ Reflexes: '/images/Skills Icons/reflexes.png', Ranged: '/images/Skills Icons/ranged.png', Melee: '/images/Skills Icons/melee.png', Medical: '/images/Skills Icons/medical.png', Tech: '/images/Skills Icons/tech.png', Influence: '/images/Skills Icons/influence.png' }[weapon.skillReq] ?? null) : null;
